...
class StatMinimums implements PlayerProcessor
{
    use HasMapStorage;
    ...
    public function __invoke(AflPlayer $player): AflPlayer
    {
        ...
        foreach ($stats as $stat => $value) {
            ...
            if ($this->storage[$stat]['perGame']['player'] === null
                || $perGame < $this->storage[$stat]['perGame']['value']
            ) {
            ...
            if ($this->storage[$stat]['total']['player'] === null
                || $value < $this->storage[$stat]['total']['value']
            ) {
